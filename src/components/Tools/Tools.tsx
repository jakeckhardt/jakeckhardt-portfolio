...
export default function Tools({}) {
    ...
    const [toolNum, setToolNum] = useState<number>(-1);
    ...
    return (
        <div className={styles.toolsInnerContainer}>
            <div 
                className={interactedWith ? [styles.tools, styles.paused].join(" ") : styles.tools}
                style={{width: width}}
            >
                {tools.map((t, i) => (
                    <div 
                        className={toolNum === i ? [styles.tool, styles.selected].join(" ") : styles.tool}
